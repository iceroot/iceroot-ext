...
public class JSONConvert {
    public static <T> com.xiaoleilu.hutool.json.JSONObject toHutoolJSONObject(T jsonObject) {
    ...
    public static <T> com.xiaoleilu.hutool.json.JSONArray toHutoolJSONArray(T jsonArray) {
    ...
    public static <T> com.alibaba.fastjson.JSONObject toFastJSONObject(T jsonObject) {
        String className = jsonObject.getClass().getName();
        if ("com.xiaoleilu.hutool.json.JSONObject".equals(className)) {
    ...
    public static <T> com.alibaba.fastjson.JSONArray toFastJSONArray(T jsonArray) {
        String className = jsonArray.getClass().getName();
        if ("com.xiaoleilu.hutool.json.JSONArray".equals(className)) {
